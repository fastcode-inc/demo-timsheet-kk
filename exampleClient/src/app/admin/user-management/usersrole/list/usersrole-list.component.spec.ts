...
describe('UsersroleListComponent', () => {
  ...
  let constData: IUsersrole[] = [
    ...
    },
    {
      roleId: 2,
      usersId: 2,
      roleDescriptiveField: 'displayName2',
      usersDescriptiveField: 'lastname2',
    },
  ];
  let data: IUsersrole[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [UsersroleListComponent, ListComponent],
        imports: [TestingModule],
        providers: [UsersroleService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'usersrole', component: UsersroleListComponent },
            { path: 'usersrole/:id', component: UsersroleDetailsComponent },
          ]),
        ],
        providers: [UsersroleService, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/usersrole/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
